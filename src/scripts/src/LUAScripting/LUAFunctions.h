...
int luaUnit_GetSoulLinkedWith(lua_State * L, UnitPointer  ptr);
...
int luaUnit_StopChannel(lua_State * L, UnitPointer  ptr);
int luaUnit_ChannelSpell(lua_State * L, UnitPointer  ptr);
...
int luaUnit_SetStandState(lua_State * L, UnitPointer  ptr);
int luaUnit_SetTauntedBy(lua_State * L, UnitPointer  ptr);
int luaUnit_SetSoulLinkedWith(lua_State * L, UnitPointer  ptr);
...
int luaGameObject_GetItemCount(lua_State * L, GameObjectPointer  ptr);
...
int luaGameObject_AddItem(lua_State * L, GameObjectPointer  ptr);
int luaGameObject_Despawn(lua_State * L, GameObjectPointer  ptr);
...
/*
int luaGameObject_GossipObjectCreateMenu(lua_State * L, GameObjectPointer  ptr);
int luaGameObject_GossipObjectMenuAddItem(lua_State * L, GameObjectPointer  ptr);
int luaGameObject_GossipObjectSendMenu(lua_State * L, GameObjectPointer  ptr);
int luaGameObject_GossipObjectComplete(lua_State * L, GameObjectPointer  ptr);
int luaGameObject_GossipObjectSendPOI(lua_State * L, GameObjectPointer  ptr);
int luaGameObject_ModUInt32Value(lua_State * L, GameObjectPointer  ptr);
int luaGameObject_ModFloatValue(lua_State * L, GameObjectPointer  ptr);
int luaGameObject_GetFloatValue(lua_State * L, GameObjectPointer  ptr);
int luaGameObject_InitPacket(lua_State * L, GameObjectPointer  ptr);
int luaGameObject_AddDataToPacket(lua_State * L, GameObjectPointer  ptr);
int luaGameObject_AddGuidDataToPacket(lua_State * L, GameObjectPointer  ptr);
int luaGameObject_SendData(lua_State * L, GameObjectPointer  ptr);
*/
