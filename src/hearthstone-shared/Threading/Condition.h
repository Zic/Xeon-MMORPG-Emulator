...
protected:
	HANDLE create_anonymous_semaphore(long cur,long max)
	{
		...
		HEARTHSTONE_INLINE void shift_generations_down()
		{
		...
		HEARTHSTONE_INLINE void dispose_entry(list_entry& entry)
		{
		...
		HEARTHSTONE_INLINE HANDLE duplicate_handle(HANDLE source)
		{
