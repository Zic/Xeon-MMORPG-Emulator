...
void BattleGroundAV::HookOnAreaTrigger(Player *Plr, uint32 Trigger)
{
    ...
    switch(Trigger)
    {
        ...
        default:
            ...
            Plr->GetSession()->SendAreaTriggerMessage("Warning: Unhandled AreaTrigger in Battleground: %u", Trigger);
            break;
    }
