...
enum SPELL_MODIFIER_TYPE
{
    ...
    SMT_ATTACK_POWER_AND_DMG_BONUS=3,// attacker power bonus for ability +x% // Seal of crusader also takes this as dmg bonus + power bonus	// Needs research
...
//    SMT_SPEED             =12,// movement speed, while given spell is active(flat is %) // TODO CHECK! ok this is not speed and is used with 23 misc to sometimes so is odd
    ...
    SMT_LAST_EFFECT_BONUS   =23,// increases points of last effect in affected spells
