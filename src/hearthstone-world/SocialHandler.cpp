...
{
	Log.Debug( "WORLD"," Received CMSG_ADD_FRIEND"  );
...
{
	Log.Debug( "WORLD"," Received CMSG_DEL_FRIEND"  );
...
{
	Log.Debug( "WORLD"," Received CMSG_ADD_IGNORE" );
...
{
	Log.Debug( "WORLD"," Received CMSG_DEL_IGNORE" );
