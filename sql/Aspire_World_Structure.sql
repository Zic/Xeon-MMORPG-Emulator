...
/*Table structure for table `aspire_teleport` */

CREATE TABLE `aspire_teleport` (
  `ID` bigint(20) NOT NULL,
  `Type` int(10) NOT NULL,
  `Restriction` int(10) NOT NULL,
  `Cost` int(20) NOT NULL,
  `CurrencyType` int(10) NOT NULL DEFAULT '0',
...
CREATE TABLE `creature_spawns` (
  ...
  PRIMARY KEY (`id`),
  KEY `b` (`map`)
) ENGINE=MyISAM AUTO_INCREMENT=3402698016 DEFAULT CHARSET=latin1 COMMENT='Spawn System';
...
) ENGINE=MyISAM AUTO_INCREMENT=619083 DEFAULT CHARSET=latin1 PACK_KEYS=0 ROW_FORMAT=FIXED COMMENT='Loot System';
...
CREATE TABLE `disenchantingloot` (
  ...
  `ffa_loot` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`index`)
) ENGINE=MyISAM AUTO_INCREMENT=21117 DEFAULT CHARSET=utf8;
...
CREATE TABLE `fishingloot` (
  ...
  PRIMARY KEY (`index`),
  UNIQUE KEY `index` (`index`)
) ENGINE=MyISAM AUTO_INCREMENT=2154 DEFAULT CHARSET=latin1 COMMENT='Loot System';
...
CREATE TABLE `gameobject_spawns` (
  ...
  PRIMARY KEY (`id`),
  KEY `Map` (`map`)
) ENGINE=MyISAM AUTO_INCREMENT=100024056 DEFAULT CHARSET=cp1251 COLLATE=cp1251_general_cs PACK_KEYS=0 ROW_FORMAT=FIXED COMMENT='Spawn System';
...
) ENGINE=MyISAM AUTO_INCREMENT=5142 DEFAULT CHARSET=latin1 COMMENT='Loot System';
...
CREATE TABLE `objectloot` (
  ...
  UNIQUE KEY `index` (`index`),
  KEY `entryid` (`entryid`)
) ENGINE=MyISAM AUTO_INCREMENT=5322 DEFAULT CHARSET=latin1 COMMENT='Loot System';
