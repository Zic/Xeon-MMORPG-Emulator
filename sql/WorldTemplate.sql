...
CREATE TABLE `creature_spawns` (
  ...
  PRIMARY KEY  (`id`),
  KEY `b` (`map`)
) ENGINE=MyISAM AUTO_INCREMENT=0 DEFAULT CHARSET=latin1 COMMENT='Spawn System';
...
) ENGINE=MyISAM AUTO_INCREMENT=0 DEFAULT CHARSET=latin1 PACK_KEYS=0 ROW_FORMAT=FIXED COMMENT='Loot System';
...
CREATE TABLE `playercreateinfo` (
  ...
  PRIMARY KEY  (`Index`)
) ENGINE=MyISAM AUTO_INCREMENT=0 DEFAULT CHARSET=latin1 COMMENT='Player System';
